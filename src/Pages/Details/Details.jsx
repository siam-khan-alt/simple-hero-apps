                ...
                <p className="text-[#627382] mt-2">Developed by 
                 ...
                 <div className="flex md:flex-row flex-col items-center md:items-start justify-start  gap-6 my-7">
                    <div>
                        ...
                        <p>Downloads</p>
                        <h4 className="font-medium md:font-extrabold text-2xl md:text-[40px]">{singleApp?.downloads}</h4>
                    </div>
                    <div >
                        <img src={ratingpng} alt="" className="h-10 w-10" />
                        <p>Average Ratings</p>
                        <h4 className="font-medium md:font-extrabold text-2xl md:text-[40px]">{singleApp?.ratingAvg}</h4>
                    </div>
                    <div>
                        <img src={repng} alt="" className="h-10 w-10" />
                        <p>Total Reviews</p>
                        <h4 className="font-medium md:font-extrabold text-2xl md:text-[40px]">{singleApp?.reviews}</h4>
                    </div>
                 </div>
